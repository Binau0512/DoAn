...
if (!empty($_SESSION['user'])) {
    ...
    <?php if ($user_session['role'] == 'admin') : ?>
        <a href='?module=admin&controller=customer&controller=dashboard'>
            <button class='login-modal' style='width:auto'><i class="fas fa-user-cog" style='font-size: 14px'></i>Đến trang quản lý</button>
        </a>
    <?php endif; ?>
    <a href='?controller=customer&action=viewProfile'>
        <button class='login-modal' style='width:auto'><i class='fas fa-user-edit' style='font-size: 14px'></i>Thông tin cá nhân</button>
    </a>
    <a href='?controller=customer&action=listOrders'>
        <button class='login-modal' style='width:auto'><i class='fas fa-receipt' style='font-size: 14px'></i>Đơn hàng
    </button>
    </a>
        ...
        <div class="row">
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                <div class="img-container">
                    <img src="./public/site/img/login-signup/anhlogin.jpg" alt="Avatar" class="avatar">
                </div>
            </div>
            ...
            <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                <div class="main-form-content">
                    ...
                    <p class="text-center" style="margin-bottom: 3rem;">Vui lòng điền thông tin dưới đây để đăng nhập</p>
                    ...
                    <div class="round">
                        ...
                        <span style="margin-left: 15px;">Ghi nhớ tài khoản</span>
                    </div>
