        ...
        <div class="main-form-content">
            ...
            <div class="row mb-3">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" placeholder="Nhập họ của bạn*" name="fname" id="su-fname" onkeyup="validateName(this, 'First name')">
                    <small id="su-fname-err"></small>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <label for="lname">Tên</label>
                    <input type="text" placeholder="Nhập tên của bạn *" name="lname" id="su-lname" onkeyup="validateName(this, 'Last name')">
            ...
            <div class="row mb-3">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" placeholder="Nhập Email của bạn *" name="email" id="su-email" onkeyup="validateEmail(this)">
                    <small id="su-email-err"></small>
                </div>

                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <label for="phone">Số điện thoại</label>
                    <input type="text" placeholder="Nhập số điện thoại của bạn *" name="phone" id="su-phone" onkeyup="validatePhone(this)">
            ...
            <input type="text" class="mb-3" placeholder="Nhập địa chỉ cụ thể *" name="address" id="su-address" onkeyup="validateNotEmpty(this, 'Address')">
