...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./public/admin/dist/img/snowy.png">
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <a href="./" class="nav-link">
                        ...
                        <i class="fas fa-home" style="font-size: 14px;"></i>Đến trang khách hàng
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color: #f0e5d4;">
            ...
            <a href="./?module=admin&controller=dashboard" class="brand-link">
                <img src="./public/site/img/snowy.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">SNOWY</span>
            </a>
