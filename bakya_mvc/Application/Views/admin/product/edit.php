...
<form action="./?module=admin&controller=product&action=update&id=<?= $_GET['id'] ?>" method="POST" enctype="multipart/form-data" name="productForm" onsubmit="return validateProductEditForm();">
    <div class="row">
        <div class="col-md-7">
            ...
            <div class=" form-group">
                ...
                <select name="origin" class="form-control">
                    ...
                    <option value="vn" <?= $product['origin'] == 'hq' ? 'selected' : '' ?>>Hàn Quốc</option>
                    <option value="vn" <?= $product['origin'] == 'nb' ? 'selected' : '' ?>>Nhật Bản</option>
                    <option value="vn" <?= $product['origin'] == 'tl' ? 'selected' : '' ?>>Thái Lan</option>
                </select>
            </div>
        ...
        <div class="col-md-5">
            ...
            <!-- <div class="form-group">
                <label for="sale_price" style="display:inline-block">Giá khuyến mãi</label> &nbsp; <small class="notice">0 is unset</small>
