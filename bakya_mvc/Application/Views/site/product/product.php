            ...
            <div class="col-md-3">
                <div class="blog-right-side">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget top_product_widget">
                        <h3 class="widget_title">Top sản phẩm</h3>
                        <?php foreach ($top_products as $pro) : ?>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="discount-price"><?= number_format($pro['sale_price'] > 0 ? $pro['sale_price'] : $pro['price'], 0, ',', '.') ?> vnđ</p>
                                    <?php if ($pro['sale_price'] > 0) : ?>
                                        <p class="old-price"><?= number_format($pro['price'], 0, ',', '.') ?> vnđ</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
                            ...
                            <li class="col-lg-3 col-sm-4 col-12">
                                <a href="./?controller=product&action=productDetail&id=<?= $product['id'] ?>">
                                    <div class="pro-block">
                                        ...
                                        <div class="pro-info">
                                            <h5><?= $product['name'] ?? '' ?></h5>
                                            <h5><?= number_format($product['sale_price'] > 0 ? $product['sale_price'] : $product['price'], 0, ',', '.') ?> vnđ</h5>
                                        </div>
                                    </div>
                                </a>
